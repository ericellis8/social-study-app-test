  <img id="pfc_minmax" onclick=""><!-- src="<?php echo $c->getFileUrlFromTheme('images/'.($start_minimized?'maximize':'minimize').'.gif'); ?>" alt=""/>-->
 <table width='100%'>
 <tr>
<!-- <td width='150px' valign='top' style='position:relative;top:0px;'>
  <ul id="pfc_channels_list"></ul>
  </td>
  <td width=''>
<!-- <h2 id="pfc_title" align='center'><?php echo $title; ?></h2>-->
...
<ul style="position:fixed; bottom 0;" 	id="pfc_channels_list"></ul>